texts = {
    ...
    "winback": "We miss you 👋\n\nYour 15 free scans are over — but your journey to healthy eating is just beginning.\n\nSubscribe and keep tracking every meal so you never miss a thing 🥗",
    "evening_summary": "🌙 Daily summary\n\nToday: *{total_cal} kcal* of {goal_cal} ({day_pct}%)\nProtein: *{total_protein} g*",
    "evening_no_logs": "📸 How was your day?\n\nNothing logged yet — don't forget about dinner.\nJust take a photo, it takes 5 seconds.",
    ...
    # ── Onboarding (new flow) ───────────────────────────────────
    "onb_welcome": "Hi! 👋 I help you track nutrition — I count calories and macros from photos or text.\n\nWhat do you want to track?",
    "onb_terms_hint": "By tapping you agree to the [terms of use](https://mealscan.org/terms.html)",
    "btn_onb_goal_lose": "🔻 Lose weight",
    "btn_onb_goal_gain": "🔺 Gain weight",
    "btn_onb_goal_maintain": "⚖️ Maintain weight",
    "btn_onb_goal_track": "📊 Just tracking nutrition",
    "onb_ask_sex": "What's your sex?",
    "onb_ask_age": "How old are you?\n\nType a number, e.g.: *28*",
    "onb_ask_weight_height": "Your weight and height?\n\nType two numbers separated by a space, e.g.: *70 175*",
    "onb_weight_height_bad": "Didn't get that 🤔 Type two numbers: weight and height\nE.g.: *70 175*",
    "onb_ask_activity": "How often do you work out?",
    "btn_onb_act_sedentary": "🪑 Rarely or never",
    "btn_onb_act_light": "🚶 1–2 times a week",
    "btn_onb_act_moderate": "🏃 3–5 times a week",
    "btn_onb_act_active": "💪 Every day",
    "onb_complete": "All set! 🎉\n\n🔥 Calorie goal: *{low}–{high} kcal/day*\n🥩 Protein: *~{protein} g/day*\n\nNow send a photo of any dish or type what you ate — and I'll count everything 📸",
    "onb_reminders_prompt": "Want me to remind you to log meals? ⏰\n\nI'll message you in the morning, at lunch and in the evening.",
