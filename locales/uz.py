texts = {
    ...
    # ── Onboarding (new flow) ───────────────────────────────────
    "onb_welcome": "Salom! 👋 Ovqatlanishni kuzatishga yordam beraman — foto yoki matndan kaloriya va makrolarni hisoblayman.\n\nNimani kuzatmoqchisiz?",
    "onb_terms_hint": "Bosib, [foydalanish shartlari](https://mealscan.org/terms.html) ga rozilik bildirasiz",
    "btn_onb_goal_lose": "🔻 Vazn yo'qotish",
    "btn_onb_goal_gain": "🔺 Vazn olish",
    "btn_onb_goal_maintain": "⚖️ Vaznni saqlash",
    "btn_onb_goal_track": "📊 Faqat ovqatlanishni kuzataman",
    "onb_ask_sex": "Jinsingizni ko'rsating:",
    "onb_ask_age": "Yoshingiz necha?\n\nRaqam yozing, masalan: *28*",
    "onb_ask_weight_height": "Vazn va bo'yingiz?\n\nIkki raqamni bo'sh joy bilan yozing, masalan: *70 175*",
    "onb_weight_height_bad": "Tushunmadim 🤔 Ikki raqamni bo'sh joy bilan yozing: vazn va bo'y\nMasalan: *70 175*",
    "onb_ask_activity": "Qanchalik tez-tez mashq qilasiz?",
    "btn_onb_act_sedentary": "🪑 Deyarli mashq qilmayman",
    "btn_onb_act_light": "🚶 Haftada 1–2 marta",
    "btn_onb_act_moderate": "🏃 Haftada 3–5 marta",
    "btn_onb_act_active": "💪 Har kuni",
    "onb_complete": "Ajoyib! 🎉\n\n🔥 Kaloriya normasi: *{low}–{high} kkal/kun*\n🥩 Oqsil: *~{protein} g/kun*\n\nEndi istalgan taomning fotoini yuboring yoki nima yеganingizni yozing — hammasini hisoblayman 📸",
    "onb_reminders_prompt": "Ovqat haqida eslatib turishimni xohlaysizmi? ⏰\n\nErtalab, tushda va kechqurun yozaman.",
