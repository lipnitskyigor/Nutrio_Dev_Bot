texts = {
    ...
    # ── Trial / Paywall ───────────────────────────────────────────
    "trial_exhausted": "❌ *Kostenlose Analysen aufgebraucht* (15 von 15)\n\nDu hast schon 15 Mahlzeiten erfasst — mach unbegrenzt weiter → /subscribe",
    "trial_last_1": "🔴 Letzte kostenlose Analyse! Danach — unbegrenzt → /subscribe",
    "trial_last_few": "⚠️ Noch {left} von {limit}. Unterbrich dein Tagebuch nicht → /subscribe",
    "trial_some_left": "🎁 Noch {left} von {limit}. Danach — unbegrenzte Analysen mit Abo",
    "trial_many_left": "🎁 Noch {left} kostenlose Analysen von {limit}",
    ...
    "winback": "Wir vermissen dich 👋\n\nDeine 15 kostenlosen Scans sind aufgebraucht — aber deine Reise zu gesunder Ernährung beginnt gerade erst.\n\nAbonniere jetzt und verfolge weiterhin jede Mahlzeit, um nichts zu verpassen 🥗",
    "evening_summary": "🌙 Tagesbilanz\n\nHeute: *{total_cal} kcal* von {goal_cal} ({day_pct}%)\nEiweiß: *{total_protein} g*",
    "evening_no_logs": "📸 Wie war dein Tag?\n\nHeute noch nichts eingetragen — vergiss das Abendessen nicht.\nEinfach ein Foto schicken, dauert 5 Sekunden.",
    ...
    # ── Onboarding (new flow) ───────────────────────────────────
    "onb_welcome": "Hallo! 👋 Ich helfe dir, deine Ernährung zu verfolgen — ich zähle Kalorien und Makros aus Fotos oder Text.\n\nWas möchtest du verfolgen?",
    "onb_terms_hint": "Mit dem Tippen stimmst du den [Nutzungsbedingungen](https://mealscan.org/terms.html) zu",
    "btn_onb_goal_lose": "🔻 Abnehmen",
    "btn_onb_goal_gain": "🔺 Zunehmen",
    "btn_onb_goal_maintain": "⚖️ Gewicht halten",
    "btn_onb_goal_track": "📊 Nur Ernährung tracken",
    "onb_ask_sex": "Dein Geschlecht:",
    "onb_ask_age": "Wie alt bist du?\n\nGib eine Zahl ein, z. B.: *28*",
    "onb_ask_weight_height": "Dein Gewicht und deine Größe?\n\nSchreibe zwei Zahlen mit Leerzeichen, z. B.: *70 175*",
    "onb_weight_height_bad": "Nicht verstanden 🤔 Schreibe zwei Zahlen mit Leerzeichen: Gewicht und Größe\nZ. B.: *70 175*",
    "onb_ask_activity": "Wie oft trainierst du?",
    "btn_onb_act_sedentary": "🪑 Kaum oder nie",
    "btn_onb_act_light": "🚶 1–2 Mal pro Woche",
    "btn_onb_act_moderate": "🏃 3–5 Mal pro Woche",
    "btn_onb_act_active": "💪 Jeden Tag",
    "onb_complete": "Super! 🎉\n\n🔥 Kalorienziel: *{low}–{high} kcal/Tag*\n🥩 Protein: *~{protein} g/Tag*\n\nSchick jetzt ein Foto von einem Gericht oder schreib, was du gegessen hast — ich rechne alles aus 📸",
    "onb_reminders_prompt": "Soll ich dich an deine Mahlzeiten erinnern? ⏰\n\nIch schreibe dir morgens, mittags und abends.",
