texts = {
    ...
    "winback": "Tęskniliśmy za tobą 👋\n\nTwoje 15 bezpłatnych skanów się skończyło — ale twoja droga do zdrowego odżywiania dopiero się zaczyna.\n\nZasubskrybuj i śledź każdy posiłek, żeby niczego nie przegapić 🥗",
    "evening_summary": "🌙 Podsumowanie dnia\n\nDziś: *{total_cal} kcal* z {goal_cal} ({day_pct}%)\nBiałko: *{total_protein} g*",
    "evening_no_logs": "📸 Jak minął dzień?\n\nDziś jeszcze nic nie zapisano — nie zapomnij o kolacji.\nZrób zdjęcie, zajmie to 5 sekund.",
    ...
    # ── Onboarding (new flow) ───────────────────────────────────
    "onb_welcome": "Cześć! 👋 Pomagam śledzić odżywianie — liczę kalorie i makra ze zdjęć lub tekstu.\n\nCo chcesz śledzić?",
    "onb_terms_hint": "Naciskając, akceptujesz [warunki użytkowania](https://mealscan.org/terms.html)",
    "btn_onb_goal_lose": "🔻 Schudnąć",
    "btn_onb_goal_gain": "🔺 Przybrać na wadze",
    "btn_onb_goal_maintain": "⚖️ Utrzymać wagę",
    "btn_onb_goal_track": "📊 Po prostu śledzę dietę",
    "onb_ask_sex": "Podaj swoją płeć:",
    "onb_ask_age": "Ile masz lat?\n\nWpisz liczbę, np.: *28*",
    "onb_ask_weight_height": "Twoja waga i wzrost?\n\nWpisz dwie liczby oddzielone spacją, np.: *70 175*",
    "onb_weight_height_bad": "Nie rozumiem 🤔 Wpisz dwie liczby oddzielone spacją: wagę i wzrost\nNp.: *70 175*",
    "onb_ask_activity": "Jak często trenujesz?",
    "btn_onb_act_sedentary": "🪑 Prawie wcale",
    "btn_onb_act_light": "🚶 1–2 razy w tygodniu",
    "btn_onb_act_moderate": "🏃 3–5 razy w tygodniu",
    "btn_onb_act_active": "💪 Każdego dnia",
    "onb_complete": "Gotowe! 🎉\n\n🔥 Cel kaloryczny: *{low}–{high} kcal/dzień*\n🥩 Białko: *~{protein} g/dzień*\n\nTeraz wyślij zdjęcie dowolnego dania lub napisz co zjadłeś — policzę wszystko 📸",
    "onb_reminders_prompt": "Chcesz, żebym przypominał o jedzeniu? ⏰\n\nBędę pisać rano, w południe i wieczorem.",
    "btn_onb_reminders_yes": "🔔 Ustaw przypomnienia",
    "btn_onb_reminders_skip": "Nie teraz",


    "dst_prompt": "⏰ W weekend w niektórych krajach przestawiono zegarki. Czy twój czas się zmienił?",
    "btn_dst_yes": "Tak, zmienił się",
    "btn_dst_no": "Nie, u nas nie zmieniają",
    "dst_saved": "✅ Gotowe! Twoja godzina: {time}. Przypomnienia będą przychodzić według niej.",
}
