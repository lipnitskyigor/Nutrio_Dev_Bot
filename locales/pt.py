texts = {
    ...
    # ── Trial / Paywall ───────────────────────────────────────────
    "trial_exhausted": "❌ *Análises gratuitas esgotadas* (15 de 15)\n\nVocê já analisou 15 pratos — continue sem limites → /subscribe",
    "trial_last_1": "🔴 Última análise gratuita! Depois — sem limite → /subscribe",
    "trial_last_few": "⚠️ Restam {left} de {limit}. Não interrompa seu diário → /subscribe",
    "trial_some_left": "🎁 Restam {left} de {limit}. Depois — análises sem limite com a assinatura",
    "trial_many_left": "🎁 Restam {left} análises gratuitas de {limit}",
    ...
    "winback": "Sentimos sua falta 👋\n\nSeus 15 scans gratuitos acabaram — mas sua jornada para uma alimentação saudável está apenas começando.\n\nAssine agora e continue acompanhando cada refeição para não perder nada 🥗",
    "evening_summary": "🌙 Resumo do dia\n\nHoje: *{total_cal} kcal* de {goal_cal} ({day_pct}%)\nProteína: *{total_protein} g*",
    "evening_no_logs": "📸 Como foi seu dia?\n\nNada registrado hoje ainda — não esqueça do jantar.\nSó tire uma foto, leva 5 segundos.",
    ...
    # ── Onboarding (new flow) ───────────────────────────────────
    "onb_welcome": "Olá! 👋 Ajudo você a monitorar sua alimentação — conto calorias e macros a partir de fotos ou texto.\n\nO que você quer acompanhar?",
    "onb_terms_hint": "Ao tocar, você concorda com os [termos de uso](https://mealscan.org/terms.html)",
    "btn_onb_goal_lose": "🔻 Perder peso",
    "btn_onb_goal_gain": "🔺 Ganhar peso",
    "btn_onb_goal_maintain": "⚖️ Manter peso",
    "btn_onb_goal_track": "📊 Só quero acompanhar minha dieta",
    "onb_ask_sex": "Qual é o seu sexo?",
    "onb_ask_age": "Quantos anos você tem?\n\nEscreva um número, ex.: *28*",
    "onb_ask_weight_height": "Seu peso e altura?\n\nEscreva dois números separados por espaço, ex.: *70 175*",
    "onb_weight_height_bad": "Não entendi 🤔 Escreva dois números separados por espaço: peso e altura\nEx.: *70 175*",
    "onb_ask_activity": "Com que frequência você treina?",
    "btn_onb_act_sedentary": "🪑 Quase nunca",
    "btn_onb_act_light": "🚶 1–2 vezes por semana",
    "btn_onb_act_moderate": "🏃 3–5 vezes por semana",
    "btn_onb_act_active": "💪 Todos os dias",
    "onb_complete": "Pronto! 🎉\n\n🔥 Meta de calorias: *{low}–{high} kcal/dia*\n🥩 Proteína: *~{protein} g/dia*\n\nAgora envie uma foto de qualquer prato ou escreva o que comeu — e eu calculo tudo 📸",
    "onb_reminders_prompt": "Quer que eu te lembre de registrar as refeições? ⏰\n\nVou te escrever de manhã, ao meio-dia e à noite.",
    "btn_onb_reminders_yes": "🔔 Configurar lembretes",
    "btn_onb_reminders_skip": "Agora não",


    "dst_prompt": "⏰ No fim de semana alguns países mudaram a hora. A sua hora mudou?",
    "btn_dst_yes": "Sim, mudou",
    "btn_dst_no": "Não, aqui não muda",
    "dst_saved": "✅ Pronto! Sua hora: {time}. Os lembretes seguirão este horário.",
}
