texts = {
    ...
    # ── Trial / Paywall ───────────────────────────────────────────
    "trial_exhausted": "❌ *Análisis gratuitos agotados* (15 de 15)\n\nYa has analizado 15 platos — continúa sin límites → /subscribe",
    "trial_last_1": "🔴 ¡Último análisis gratuito! Después — sin límite → /subscribe",
    "trial_last_few": "⚠️ Quedan {left} de {limit}. No interrumpas tu diario → /subscribe",
    "trial_some_left": "🎁 Quedan {left} de {limit}. Después — análisis sin límite con la suscripción",
    "trial_many_left": "🎁 Quedan {left} análisis gratuitos de {limit}",
    ...
    # ── Onboarding (new flow) ───────────────────────────────────
    "onb_welcome": "¡Hola! 👋 Te ayudo a hacer seguimiento de tu alimentación — cuento calorías y macros desde fotos o texto.\n\n¿Qué quieres seguir?",
    "onb_terms_hint": "Al pulsar, aceptas los [términos de uso](https://mealscan.org/terms.html)",
    "btn_onb_goal_lose": "🔻 Perder peso",
    "btn_onb_goal_gain": "🔺 Ganar peso",
    "btn_onb_goal_maintain": "⚖️ Mantener peso",
    "btn_onb_goal_track": "📊 Solo quiero seguir mi dieta",
    "onb_ask_sex": "¿Cuál es tu sexo?",
    "onb_ask_age": "¿Cuántos años tienes?\n\nEscribe un número, p. ej.: *28*",
    "onb_ask_weight_height": "¿Tu peso y estatura?\n\nEscribe dos números separados por espacio, p. ej.: *70 175*",
    "onb_weight_height_bad": "No entendí 🤔 Escribe dos números separados por espacio: peso y estatura\nP. ej.: *70 175*",
    "onb_ask_activity": "¿Con qué frecuencia entrenas?",
    "btn_onb_act_sedentary": "🪑 Casi nunca",
    "btn_onb_act_light": "🚶 1–2 veces por semana",
    "btn_onb_act_moderate": "🏃 3–5 veces por semana",
    "btn_onb_act_active": "💪 Todos los días",
    "onb_complete": "¡Listo! 🎉\n\n🔥 Meta de calorías: *{low}–{high} kcal/día*\n🥩 Proteína: *~{protein} g/día*\n\nAhora envía una foto de cualquier plato o escribe qué comiste — y lo calcularé todo 📸",
    "onb_reminders_prompt": "¿Quieres que te recuerde registrar tus comidas? ⏰\n\nTe escribiré por la mañana, al mediodía y por la noche.",
