texts = {
    ...
    "winback": "اشتقنا إليك 👋\n\nانتهت عمليات المسح الـ15 المجانية — لكن رحلتك نحو التغذية الصحية بدأت للتو.\n\nاشترك الآن واستمر في تتبع كل وجبة حتى لا تفوتك أي تفصيلة 🥗",
    "evening_summary": "🌙 ملخص اليوم\n\nاليوم: *{total_cal} سعرة* من {goal_cal} ({day_pct}%)\nالبروتين: *{total_protein} غ*",
    "evening_no_logs": "📸 كيف كان يومك؟\n\nلم يتم تسجيل أي شيء اليوم — لا تنسَ العشاء.\nفقط التقط صورة، سيستغرق 5 ثوانٍ.",
    ...
    # ── Onboarding (new flow) ───────────────────────────────────
    "onb_welcome": "مرحباً! 👋 أساعدك في متابعة تغذيتك — أحسب السعرات والمغذيات من الصور أو النص.\n\nماذا تريد تتبعه؟",
    "onb_terms_hint": "بالضغط، أنت توافق على [شروط الاستخدام](https://mealscan.org/terms.html)",
    "btn_onb_goal_lose": "🔻 إنقاص الوزن",
    "btn_onb_goal_gain": "🔺 زيادة الوزن",
    "btn_onb_goal_maintain": "⚖️ الحفاظ على الوزن",
    "btn_onb_goal_track": "📊 مجرد متابعة التغذية",
    "onb_ask_sex": "ما جنسك؟",
    "onb_ask_age": "كم عمرك؟\n\naكتب رقماً، مثلاً: *28*",
    "onb_ask_weight_height": "وزنك وطولك؟\n\nاكتب رقمين مفصولين بمسافة، مثلاً: *70 175*",
    "onb_weight_height_bad": "لم أفهم 🤔 اكتب رقمين مفصولين بمسافة: الوزن والطول\nمثلاً: *70 175*",
    "onb_ask_activity": "كم مرة تتمرن في الأسبوع؟",
    "btn_onb_act_sedentary": "🪑 نادراً أو لا أتمرن",
    "btn_onb_act_light": "🚶 مرة أو مرتان في الأسبوع",
    "btn_onb_act_moderate": "🏃 3–5 مرات في الأسبوع",
    "btn_onb_act_active": "💪 كل يوم",
    "onb_complete": "رائع! 🎉\n\n🔥 هدف السعرات: *{low}–{high} سعرة/يوم*\n🥩 البروتين: *~{protein} غ/يوم*\n\nالآن أرسل صورة أي طبق أو اكتب ما أكلت — وسأحسب كل شيء 📸",
    "onb_reminders_prompt": "هل تريد أن أذكرك بتسجيل وجباتك؟ ⏰\n\nسأكتب لك صباحاً وظهراً ومساءً.",
    "btn_onb_reminders_yes": "🔔 إعداد التذكيرات",
    "btn_onb_reminders_skip": "ليس الآن",


    "dst_prompt": "⏰ في عطلة نهاية الأسبوع تغيّرت الساعة في بعض الدول. هل تغيّر وقتك؟",
    "btn_dst_yes": "نعم، تغيّر",
    "btn_dst_no": "لا، لا تتغيّر عندنا",
    "dst_saved": "✅ تم! وقتك الآن: {time}. ستصل التذكيرات حسب هذا الوقت.",
}
